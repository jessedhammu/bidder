...
$html .= '<div class="left"><strong>' . htmlspecialchars($vendor_name) . '</strong><br><span class="small">' . htmlspecialchars($vendor_email) . ' | ' . htmlspecialchars($vendor_phone) . '</span></div>';
$html .= '<div class="right"><strong>Basket:</strong> ' . htmlspecialchars($basket['bid_code']) . '<br><span class="small">' . htmlspecialchars($basket['title']) . '</span></div>';
$html .= '</div>';
